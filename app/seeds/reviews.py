...
def seed_reviews():
    ...
    review4 = Review(rating="3.0", body="Fun but a bit too difficult", user_id=2,trivia_package_id=6)
    ...
    review9 = Review(rating="4.5", body="The questions well well thought out", user_id=3,trivia_package_id=4)
    review10 = Review(rating="2.5", body="Nothing inspiring but had the genre correct", user_id=3,trivia_package_id=5)
    review11 = Review(rating="3.0", body="I don't know much information about celebrities, but I feel like I learned something by playing!", user_id=1,trivia_package_id=4)
    review12 = Review(rating="4.0", body="Great Job! Needs some more questions about 90's sitcoms", user_id=1,trivia_package_id=5)
    review13 = Review(rating="4.0", body="Wow! Good work! I would try this again", user_id=1,trivia_package_id=6)
    review14 = Review(rating="3.0", body="It was okay. Would need more questions for me to play again", user_id=1,trivia_package_id=7)
