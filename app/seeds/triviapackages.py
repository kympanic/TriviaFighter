...
def seed_trivia_packages():
    ...
    triviapackage6 = TriviaPackage(
        name="Player 1 Ready", category="Entertainment: Video Games", description="Only for the hardcore gamer", difficulty="Hard", user_id=3, image_url="" )
    triviapackage7 = TriviaPackage(
        name="Everyone and Everything", category="General Knowledge", description="Lets get it! How much do you actually know?", difficulty="Easy", user_id=3, image_url="https://trivia-fighter.s3.us-west-2.amazonaws.com/Images/videogamefatcat.jpg" )
  
    db.session.add_all([triviapackage1])
